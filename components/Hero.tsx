...
export function Hero() {
  return (
    <section
      id="home"
      className="relative scroll-mt-24 lg:scroll-mt-32 overflow-hidden pb-20 pt-28 sm:pt-32 bg-gradient-to-br from-stone-50 via-slate-50/50 to-stone-50"
      aria-labelledby="home-title"
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-0 h-[540px] w-[540px] -translate-x-1/2 rounded-full bg-sage-100/20 blur-3xl" />
        <div className="absolute bottom-0 right-0 h-[420px] w-[420px] translate-x-1/3 rounded-full bg-sage-200/15 blur-3xl" />
      </div>
      <div className="relative mx-auto max-w-6xl px-6 md:px-8 lg:max-w-7xl xl:max-w-[1400px]">
        ...
        >
          <div className="space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full bg-white/90 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-sage-600 shadow-soft backdrop-blur">
                <span>Cozy Clean ATX — Elevated Commercial Cleaning in Austin, TX</span>
              </div>
              <h1
                id="home-title"
                className="mt-6 max-w-2xl font-display text-4xl font-semibold text-slate-800 sm:text-5xl lg:text-6xl"
              >
                Calm, Reliable Cleaning for Austin Businesses
              </h1>
              <div className="mt-6 space-y-2 max-w-2xl text-lg leading-relaxed text-slate-600 sm:text-xl lg:max-w-3xl">
                <p>
                  Premium cleaning services for offices, storefronts, clinics, and short-term rentals across Austin. Trusted teams, flexible scheduling, zero drama.
                </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <CallActionButton className="cleaning-effect rounded-full bg-sage-500 px-7 py-3.5 text-base font-semibold text-white shadow-soft transition hover:bg-sage-600 hover:-translate-y-0.5">
                Call {siteConfig.phoneDisplay}
              </CallActionButton>
              <a
                href={`mailto:${siteConfig.email}`}
                className="cleaning-effect rounded-full border-2 border-sage-200 bg-white/90 px-7 py-3.5 text-base font-semibold text-sage-700 shadow-soft transition hover:-translate-y-0.5 hover:border-sage-300 hover:bg-white"
              >
          ...
          >
            ...
            >
              ...
              <div className="absolute -top-8 right-6 rounded-full bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-sage-600 shadow-soft z-20">
                Locally Owned
              </div>
