...
const faqs = [
  ...
  {
    question: "Which types of businesses do you work with in Chattanooga?",
    answer:
...
export function PricingSection() {
  ...
  return (
    <SectionWrapper
      id="pricing"
      className="mx-auto mt-12 max-w-6xl px-6 py-16 sm:py-20 lg:py-24 md:px-8 lg:max-w-7xl xl:max-w-[1400px] bg-gradient-to-br from-white via-lavender-50/20 to-blossom-50/20"
    >
        ...
        <div className="grid grid-cols-1 gap-8 rounded-[32px] border border-white/60 bg-white/85 p-8 shadow-[0_40px_120px_-70px_rgba(122,66,255,0.55)] backdrop-blur-lg lg:grid-cols-[1fr_1.1fr] lg:gap-12 lg:p-12">
          <div className="space-y-6">
            <div className="grid gap-6">
              <div className="rounded-3xl border border-lavender-100 bg-lavender-50/70 p-8 text-left text-slate-700 shadow-inner">
                ...
                <ul className="mt-4 space-y-3 text-sm leading-relaxed">
                  <li className="flex items-start gap-3">
                    <span className="mt-1 text-lg text-lavender-500">•</span>
            ...
            <div className="rounded-3xl border border-white/60 bg-white/90 p-6 text-left text-slate-700 shadow-inner">
              ...
              <CallActionButton className="cleaning-effect mt-6 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-lavender-400 via-blossom-400 to-mint-400 px-6 py-3 text-sm font-semibold text-white shadow-pastel transition hover:-translate-y-0.5 hover:shadow-glow">
            ...
            <div className="space-y-3">
              {faqs.map((faq, index) => {
                ...
                return (
                  <div
                    key={faq.question}
                    className="overflow-hidden rounded-2xl border border-white/60 bg-white/75 shadow-sm transition hover:border-lavender-200"
                  >
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <span
                        className="flex h-10 w-10 items-center justify-center rounded-full border border-white/70 bg-white/80 text-lg text-lavender-500 shadow-inner"
                        aria-hidden="true"
                      >
                        {isOpen ? "−" : "+"}
                      </span>
