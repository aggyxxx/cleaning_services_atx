      ...
      <div className="space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative hidden pt-16 lg:block">
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-lavender-200 via-blossom-200 to-mint-200 z-0" />
              ...
              {steps.map((item, index) => (
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    <div className="h-8 w-0.5 bg-gradient-to-b from-lavender-200 via-blossom-200 to-mint-200" />
                    <div className="z-10 h-4 w-4 rounded-full border-2 border-white bg-lavender-300 shadow-sm" />
                  </div>
                  <div className="relative w-full rounded-3xl border border-white/70 bg-white/80 p-6 text-center shadow-[0_20px_60px_-30px_rgba(145,102,255,0.3)] transition hover:-translate-y-1 hover:shadow-pastel">
                    <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-lavender-100 via-blossom-100 to-mint-100 text-2xl shadow-sm">
                      {item.icon}
                    </div>
                    <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-full bg-lavender-200 text-xs font-bold text-lavender-700">
                      {item.step}
                    </div>
            ...
            {steps.map((item, index) => (
              ...
              >
                {index < steps.length - 1 && (
                  <div className="absolute left-6 top-16 bottom-0 w-0.5 bg-gradient-to-b from-lavender-200 via-blossom-200 to-mint-200" />
                )}
                <div className="absolute left-0 top-0 flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-lavender-100 via-blossom-100 to-mint-100 text-xl shadow-sm z-10">
                  {item.icon}
                </div>
                <div className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-[0_20px_60px_-30px_rgba(145,102,255,0.3)]">
                  <div className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-lavender-200 text-xs font-bold text-lavender-700 mb-3">
                    {item.step}
                  </div>
                  <h3 className="font-display text-lg font-semibold text-slate-900 mb-2">
                    {item.title}
