...
export function WhyChooseUsSection() {
  ...
  return (
    <SectionWrapper
      id="benefits"
      className="mx-auto mt-12 max-w-6xl px-6 py-16 sm:py-20 lg:py-24 md:px-8 lg:max-w-7xl xl:max-w-[1400px] bg-stone-50/50"
    >
        ...
        <div className="grid gap-5">
          {differentiators.map((item, index) => (
            <motion.div
              ...
              className="group flex gap-5 rounded-3xl border border-white/60 bg-white/70 p-6 shadow-inner transition hover:border-sage-200 hover:shadow-soft"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-sage-100 text-xl">
                {item.icon}
              </div>
