...
export function QuoteSection() {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[36px] border border-white/60 bg-gradient-to-br from-lavender-200/80 via-blossom-200/70 to-mint-200/70 p-[1px] shadow-[0_35px_120px_-60px_rgba(145,102,255,0.6)] backdrop-blur-xl">
        <div className="rounded-[34px] bg-white/92 px-8 py-12 text-center shadow-inner md:px-16 md:py-14">
          ...
          <CallActionButton className="cleaning-effect mt-8 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-lavender-400 via-blossom-400 to-mint-400 px-7 py-3.5 text-base font-semibold text-white shadow-pastel transition hover:-translate-y-0.5 hover:shadow-glow">
