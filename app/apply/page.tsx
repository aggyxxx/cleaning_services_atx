        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="mt-5 mx-auto max-w-3xl text-base leading-relaxed text-slate-600 lg:text-lg">
              Chattanooga Commercial Cleaning is hiring reliable, detail-oriented cleaners for commercial spaces and Airbnb turnovers in the Chattanooga area. We value professionalism, reliability, and offer flexible scheduling to fit your lifestyle.
            </p>
          </div>
          ...
          <div className="rounded-[32px] border border-white/60 bg-gradient-to-br from-white/95 via-blossom-50/40 to-lavender-50/40 p-8 shadow-[0_45px_140px_-75px_rgba(71,85,105,0.45)] backdrop-blur-xl md:p-12">
            {submitStatus === "success" ? (
              <div className="text-center py-12">
                ...
                <a
                  href="/"
                  className="cleaning-effect inline-flex items-center justify-center rounded-full bg-gradient-to-r from-lavender-400 via-blossom-400 to-mint-400 px-7 py-3.5 text-base font-semibold text-white shadow-pastel transition hover:-translate-y-0.5 hover:shadow-glow"
                >
                  Return to Home
                </a>
              </div>
              ...
              >
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      } bg-white/80 px-4 text-sm text-slate-600 shadow-inner focus:border-lavender-300 focus:outline-none focus:ring-4 focus:ring-lavender-200/60`}
                      required
                    />
                    {errors.name && (
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    } bg-white/80 px-4 py-3 text-sm text-slate-600 shadow-inner focus:border-lavender-300 focus:outline-none focus:ring-4 focus:ring-lavender-200/60 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-lavender-100 file:text-lavender-700 hover:file:bg-lavender-200 file:cursor-pointer`}
                    required
                  />
